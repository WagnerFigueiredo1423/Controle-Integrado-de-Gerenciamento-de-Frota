...
namespace FNC
{
    public static class sys_funcoesFNC
    {
        ...
        public static void geraLog(string tipoRegistro, string form, string usuario, string evento)
        {
            string nome_arquivo = @"\\Servidor\d\PROGRAMAS\controle de caminhões\log\" + form + ".txt";
