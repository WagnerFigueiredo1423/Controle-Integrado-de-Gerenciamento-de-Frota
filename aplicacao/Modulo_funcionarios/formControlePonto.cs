...
namespace aplicacao
{
    public partial class formControlePonto : Form
    {
        ...
        private void carregaPonto(DateTime competencia, DateTime HrEntManha1, DateTime HrEntManha2, DateTime HrSaiManha1, DateTime HrSaiManha2, DateTime HrEntTarde1, DateTime HrEntTarde2, DateTime HrSaiTarde1, DateTime HrSaiTarde2)
        {
            ...
            for (int i = 0; i < dtbFuncionarios.Rows.Count; i++)
            {
                ...
                DataTable dtbPonto = dtsPonto.Tables.Add(dtbFuncionarios.Rows[i]["nome"].ToString().Replace(" ", ""));
                ...
                Control[] tabPonto = this.Controls.Find("tabPonto" + dtbFuncionarios.Rows[i]["nome"].ToString().Replace(" ", ""), true);
                ...
                for (int j = 0; j < dias; j++)
                {
                    ...
                    foreach (Feriado f in listaFeriados)
                    {
                        if (f.Data == data)
                        {
                            row["ent_manha"] = HrEntManha1.AddMinutes(rd.Next(0, difEntManha.Minutes)).ToString("HH:mm");
        ...
        private void txtCompetencia_ValueChanged(object sender, EventArgs e)
        {
            carregaPonto(txtCompetencia.Value, _hrEntManha1, _hrEntManha2, _hrSaiManha1, _hrSaiManha2, _hrEntTarde1, _hrEntTarde2, _hrSaiTarde1, _hrSaiTarde2);
