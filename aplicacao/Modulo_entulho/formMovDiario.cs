...
namespace aplicacao
{
    public partial class formMovDiario : Form
    {
        ...
        private void carregaConteiners()
        {
            ...
            dtb = sys_conteineresBLL.ListarBLL("SELECT id,numero FROM gauchateleentu.sys_conteineres WHERE situacao = 'DISPONÍVEL' AND tipo = 'Entulho' AND ativo = true ORDER BY id ASC");
        ...
        private void btnLocalizarGoogle_Click(object sender, EventArgs e)
        {
            ...
            if (rdbCep.Checked && txtEndereco.Text.Length <= 9)
            {
                //var result = new aplicacao.WebServiceCEP
        ...
        private void cellDatePickerPrevEntregaValueChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET previsao_entrega = '" + oDateTimePicker.Value.ToString("yyyy-MM-dd hh:mm") + "' WHERE id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
        ...
        private void cellDatePickerDataEntregaValueChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET situacao = 'Entregue', data_entrega = '" + oDateTimePicker.Value.ToString("yyyy-MM-dd") + "', previsao_retirada = '" + data.Date.ToString("yyyy-MM-dd hh:mm") + "', listagem_entrega = false, urgencia_entrega = false WHERE id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
                        sys_pagamentosBLL.AtualizarComPatametroBLL("UPDATE gauchateleentu.sys_pagamentos SET situacao = 'EFETIVO' WHERE sys_locacoes_id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
                        tabMov.CurrentRow.Cells["situacao"].Value = "Entregue";
                    }
                    else
                    {
                        sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET data_entrega = '" + oDateTimePicker.Value.ToString("yyyy-MM-dd") + "', previsao_retirada = '" + data.Date.ToString("yyyy-MM-dd hh:mm") + "' WHERE id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
                    }
                }
                catch (Exception er)
                {
        ...
        private void cellDatePickerPrevRetiradaValueChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET previsao_retirada = '" + oDateTimePicker.Value.ToString("yyyy-MM-dd hh:mm") + "' WHERE id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
                dtbLocacoes = sys_locacoesBLL.ListarTudoBLL(dataIni, dataFim, "");
                timer1.Start();
        ...
        private void cellDatePickerDataRetiradaValueChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                    ...
                    tabMov.CurrentRow.Cells["data_retirada"].Value.ToString() != "")
                {
                    ...
                    {
                        string sqlCommand = "UPDATE gauchateleentu.sys_locacoes SET "
                    ...
                    {
                        sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET data_retirada = '" + oDateTimePicker.Value.ToString("yyyy-MM-dd") + "' WHERE id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
                    }
                }
                else
                {
        ...
        private void cellDatePickerDataAutorizacaoValueChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET val_autorizacao = '" + oDateTimePicker.Value.ToString("yyyy-MM-dd") + "', previsao_retirada = '" + oDateTimePicker.Value.ToString("yyyy-MM-dd hh:mm") + "' WHERE id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
                dtbLocacoes = sys_locacoesBLL.ListarTudoBLL(dataIni, dataFim, "");
                timer1.Start();
        ...
        private void cellDropMotEntregaSelectedValueChanged(object sender, EventArgs e)
        {
            ...
            if (idFunc != 0)
            {
                try
                {
                    ...
                    {
                        string sqlCommandLocacao = "UPDATE gauchateleentu.sys_locacoes SET "
                        + "situacao = 'Entregue', "
                        ...
                        string sqlCommandCaixa = "UPDATE gauchateleentu.sys_pagamentos SET "
                        + "situacao = 'EFETIVO' "
                    ...
                    {
                        sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET func_entrega_id = " + idFunc + " WHERE id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
                    }
                    dtbLocacoes = sys_locacoesBLL.ListarTudoBLL(dataIni, dataFim, "");
                    timer1.Start();
        ...
        private void cellDropMotRetiradaSelectedValueChanged(object sender, EventArgs e)
        {
            ...
            if (idFunc != 0)
            {
                try
                {
                    if (tabMov.CurrentRow.Cells["data_entrega"].Value.ToString() != "" && tabMov.CurrentRow.Cells["drop_func_entrega"].Value.ToString() != "0" && tabMov.CurrentRow.Cells["drop_veic_entrega"].Value.ToString() != "0" && tabMov.CurrentRow.Cells["numero_conteiner"].Value.ToString() != "" && tabMov.CurrentRow.Cells["numero_os"].Value.ToString() != "" && tabMov.CurrentRow.Cells["drop_func_retirada"].Value.ToString() != "0" && tabMov.CurrentRow.Cells["drop_veic_retirada"].Value.ToString() != "0" && tabMov.CurrentRow.Cells["data_retirada"].Value.ToString() != "")
                    {
                        if (tabMov.CurrentRow.Cells["situacao"].Value.ToString() == "Entregue" || tabMov.CurrentRow.Cells["situacao"].Value.ToString() == "Ag.Retirada")
                        {
                            sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET func_retirada_id = " + idFunc + ", situacao = 'Finalizada', listagem_retirada = false, listagem_entrega = false, urgencia_entrega = false, urgencia_retirada = false WHERE id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
                        ...
                        {
                            sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET func_retirada_id = " + idFunc + " WHERE id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
                        }
                    }
                    else
                    {
        ...
        private void cellDropVeicEntregaSelectedValueChanged(object sender, EventArgs e)
        {
            ...
            if (idVeic != 0)
            {
                try
                {
                    ...
                    {
                        sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET veic_entrega_id = " + idVeic + " WHERE id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
                    }
                    dtbLocacoes = sys_locacoesBLL.ListarTudoBLL(dataIni, dataFim, "");
                    timer1.Start();
        ...
        private void cellDropVeicRetiradaSelectedValueChanged(object sender, EventArgs e)
        {
            ...
            if (idVeic != 0)
            {
                try
                {
                    if (tabMov.CurrentRow.Cells["data_entrega"].Value.ToString() != "" && tabMov.CurrentRow.Cells["drop_func_entrega"].Value.ToString() != "0" && tabMov.CurrentRow.Cells["drop_veic_entrega"].Value.ToString() != "0" && tabMov.CurrentRow.Cells["numero_conteiner"].Value.ToString() != "" && tabMov.CurrentRow.Cells["numero_os"].Value.ToString() != "" && tabMov.CurrentRow.Cells["drop_func_retirada"].Value.ToString() != "0" && tabMov.CurrentRow.Cells["data_retirada"].Value.ToString() != "")
                    {
                        if (tabMov.CurrentRow.Cells["situacao"].Value.ToString() == "Entregue" || tabMov.CurrentRow.Cells["situacao"].Value.ToString() == "Ag.Retirada")
                        {
                            sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET veic_retirada_id = " + idVeic + ", situacao = 'Finalizada', listagem_retirada = false, listagem_entrega = false, urgencia_entrega = false, urgencia_retirada = false WHERE id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
                            sys_FNCBLL.atualizaStatusConteinerBLL(sys_FNCBLL.retornaIdConteinerBLL(int.Parse(tabMov.CurrentRow.Cells["numero_conteiner"].Value.ToString()), "ENTULHO").ID, "DISPONÍVEL");
                            tabMov.CurrentRow.Cells["situacao"].Value = "Finalizada";
                        }
                        else
                        {
                            sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET veic_retirada_id = " + idVeic + " WHERE id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
                        }
                    }
                    else
                    {
        ...
        private void cellDropCobrancaSelectedValueChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET cobranca = '" + sendingCB.EditingControlFormattedValue.ToString() + "' WHERE id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
                timer1.Start();
        ...
        private void cellDropTipoSelectedValueChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET tipo = '" + sendingCB.EditingControlFormattedValue.ToString() + "' WHERE id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
                timer1.Start();
        ...
        private void carregaMovimento(DataTable _dtb)
        {
            ...
            try
            {
                ...
                tabMov.Columns["previsao_entrega"].Width = 120;
                tabMov.Columns["data_entrega"].HeaderText = "Entrega";
                tabMov.Columns["data_entrega"].Width = 90;
                ...
                //tabMov.Columns["urgencia_entrega"].Width = 40;
                tabMov.Columns["listagem_entrega"].HeaderText = "List. Ent.";
                //tabMov.Columns["listagem_entrega"].Width = 40;
                ...
                foreach (DataGridViewRow row in tabMov.Rows)
                {
                        ...
                        tabMov.Rows[row.Index].Cells["situacao"].Value.ToString() == "Entregue")
                    {
                        if (Convert.ToDateTime(tabMov.Rows[row.Index].Cells["previsao_retirada"].Value) < DateTime.Now.Date.AddDays(-1))
                        {
                            ...
                            string sqlComand = "UPDATE gauchateleentu.sys_locacoes"
        ...
        private void tabMov_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == tabMov.Columns["urgencia_entrega"].Index)
            {
                ...
                try
                {
                    sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET urgencia_entrega = " + tabMov.Rows[e.RowIndex].Cells[tabMov.Columns["urgencia_entrega"].Index].Value.ToString() + " WHERE id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
                    timer1.Start();
            ...
            else if (e.ColumnIndex == tabMov.Columns["urgencia_retirada"].Index)
            {
                ...
                try
                {
                    sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET urgencia_retirada = " + tabMov.Rows[e.RowIndex].Cells[tabMov.Columns["urgencia_retirada"].Index].Value.ToString() + " WHERE id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
                    timer1.Start();
                    //parent.lblMessage.Text = "Urgencia na Entrega Alterada";
                }
                catch (Exception er)
            ...
            else if (e.ColumnIndex == tabMov.Columns["quitado"].Index)
            {
                ...
                try
                {
                    sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_pagamentos SET quitado = " + tabMov.Rows[e.RowIndex].Cells[tabMov.Columns["quitado"].Index].Value.ToString() + " WHERE id = " + sys_FNCBLL.retornaIdItem(tabMov.CurrentRow.Cells["id"].Value.ToString(), "sys_locacoes_id", "sys_pagamentos") + ";");
                    timer1.Start();
            ...
            else if (e.ColumnIndex == tabMov.Columns["listagem_entrega"].Index)
            {
                ...
                if (tabMov.Rows[e.RowIndex].Cells[tabMov.Columns["listagem_entrega"].Index].Value.Equals(false))
                {
                    try
                    {
                        ...
                        {
                            sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET situacao = 'Agendada', listagem_entrega = false WHERE id = " + tabMov.Rows[e.RowIndex].Cells["id"].Value.ToString() + ";");
                            timer1.Start();
                ...
                else
                {
                    ...
                    try
                    {
                        sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET func_entrega_id = " + mdlLocacao.FUNC_ENTREGA_ID + ", veic_entrega_id = " + mdlLocacao.VEIC_ENTREGA_ID + ", situacao = 'Ag.Entrega', listagem_entrega = true WHERE id = " + tabMov.Rows[e.RowIndex].Cells["id"].Value.ToString() + ";");
                        timer1.Start();
            ...
            else if (e.ColumnIndex == tabMov.Columns["listagem_retirada"].Index)
            {
                ...
                if (tabMov.Rows[e.RowIndex].Cells[tabMov.Columns["listagem_retirada"].Index].Value.Equals(false))
                {
                    try
                    {
                        ...
                        {
                            sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET situacao = 'Entregue', listagem_retirada = false WHERE id = " + tabMov.Rows[e.RowIndex].Cells["id"].Value.ToString() + ";");
                            timer1.Start();
                ...
                else
                {
                    ...
                    try
                    {
                        sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET situacao = 'Ag.Retirada', func_retirada_id = " + mdlLocacao.FUNC_ENTREGA_ID + ", veic_retirada_id = " + mdlLocacao.VEIC_ENTREGA_ID + ", listagem_retirada = true WHERE id = " + tabMov.Rows[e.RowIndex].Cells["id"].Value.ToString() + ";");
                        timer1.Start();
            ...
            else if (e.ColumnIndex == tabMov.Columns["anular"].Index)
            {
                if (tabMov.Rows[e.RowIndex].Cells["situacao"].Value.ToString() != "Anulada")
                {
                    if (MessageBox.Show("A Locação com código " + tabMov.Rows[e.RowIndex].Cells["id"].Value + " será Anulada, deseja continuar?", "Mensagem", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        ...
                        sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET situacao = 'Anulada' WHERE id = " + tabMov.Rows[e.RowIndex].Cells["id"].Value + ";");
                        sys_pagamentosBLL.AtualizarComPatametroBLL("UPDATE gauchateleentu.sys_pagamentos SET situacao = 'ANULADO' WHERE sys_locacoes_id = " + tabMov.Rows[e.RowIndex].Cells["id"].Value + ";");
                    }
                ...
                else
                {
                    ...
                    if (tabMov.Rows[e.RowIndex].Cells["func_entrega"].Value.ToString() == "" && tabMov.Rows[e.RowIndex].Cells["veic_entrega"].Value.ToString() == "" && tabMov.Rows[e.RowIndex].Cells["numero_conteiner"].Value.ToString() == "" && tabMov.Rows[e.RowIndex].Cells["numero_os"].Value.ToString() == "")//Agendada
                    {
                        ...
                        {
                            sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET situacao = '" + status + "' WHERE id = " + tabMov.Rows[e.RowIndex].Cells["id"].Value + ";");
                            sys_pagamentosBLL.AtualizarComPatametroBLL("UPDATE gauchateleentu.sys_pagamentos SET situacao = 'ABERTO' WHERE sys_locacoes_id = " + tabMov.Rows[e.RowIndex].Cells["id"].Value + ";");
                        }
                    }
                    else if (tabMov.Rows[e.RowIndex].Cells["func_entrega"].Value.ToString() != "" && tabMov.Rows[e.RowIndex].Cells["veic_entrega"].Value.ToString() != "" && tabMov.Rows[e.RowIndex].Cells["numero_conteiner"].Value.ToString() == "" && tabMov.Rows[e.RowIndex].Cells["numero_os"].Value.ToString() == "")//Ag.Entrega
                    {
                        ...
                        {
                            sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET situacao = '" + status + "' WHERE id = " + tabMov.Rows[e.RowIndex].Cells["id"].Value + ";");
                            sys_pagamentosBLL.AtualizarComPatametroBLL("UPDATE gauchateleentu.sys_pagamentos SET situacao = 'EFETIVO' WHERE sys_locacoes_id = " + tabMov.Rows[e.RowIndex].Cells["id"].Value + ";");
                        }
                    }
                    ...
                    tabMov.Rows[e.RowIndex].Cells["entrega"].Value.ToString().Length != 0)
            {
                if (tabMov.Rows[e.RowIndex].Cells["func_entrega"].Value.ToString().Length == 0)
                {
                    ...
                    sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET func_entrega_id = " + formMotVeic.funcId + ", veic_entrega_id = " + formMotVeic.veicId + ", situacao = 'Ag.Retirada', listagem_retirada = true, urgencia_retirada = true WHERE id = " + tabMov.Rows[e.RowIndex].Cells["id"].Value + ";");
                    ...
                    tabMov.Rows[e.RowIndex].Cells["retira"].Value.ToString().Length != 0)
            {
                if (tabMov.Rows[e.RowIndex].Cells["func_entrega"].Value.ToString().Length == 0)
                {
                    formMotVeic formMotVeic = new formMotVeic(this);
                    formMotVeic.ShowDialog();
                    sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET func_retirada_id = " + formMotVeic.funcId + ", veic_retirada_id = " + formMotVeic.veicId + ", situacao = 'Ag.Retirada', listagem_retirada = true, urgencia_retirada = true WHERE id = " + tabMov.Rows[e.RowIndex].Cells["id"].Value + ";");
                    Clipboard.SetText(@"---ENTREGA---
                    MOTORISTA: " + sys_funcionariosBLL.MostrarBLL(formMotVeic.funcId).NOME + @".
                    CLIENTE: " + tabMov.Rows[e.RowIndex].Cells["nome"].Value.ToString() + @".
                    ENDEREÇO: " + tabMov.Rows[e.RowIndex].Cells["endereco"].Value.ToString() + @".
        ...
        private void tabMov_CellValidated(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == tabMov.Columns["numero_os"].Index && tabMov.CurrentRow.Cells["numero_os"].Value.ToString() != "")
            {
                try
                {
                    ...
                    {
                        sys_locacoesBLL.AtualizarComParametroBLL("UPDATE gauchateleentu.sys_locacoes SET numero_os = '" + tabMov.CurrentRow.Cells["numero_os"].Value.ToString() + "' WHERE id = " + tabMov.CurrentRow.Cells["id"].Value + ";");
                    }
                    dtbLocacoes = sys_locacoesBLL.ListarTudoBLL(dataIni, dataFim, "");
                    timer1.Start();
        ...
        public void TextBoxMoeda(TextBox txt)
        {
