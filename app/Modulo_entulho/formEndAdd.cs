...
namespace app
{
    public partial class formEndAdd : Form
    {
        public formEndAdd()
        {
            InitializeComponent();
              ...
              <body onload='initialize()'>
                ...
                <table id='address'>
                  ...
                  <tr>
                    ...
                    <td class='wideField' colspan='3'><input class='field' id='complemento'></input></td>
                  ...
                  <tr>
                    ...
                    <td class='wideField' colspan='3'><input class='field' id='mapa'></input></td>
                  </tr>
                </table>
              </body>
            </html>";
