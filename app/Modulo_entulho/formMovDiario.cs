...
namespace app
{
    public partial class formMovDiario : Form
    {
        ...
        private void carregaFuncionarios()
        {
            ...
            DataRow row1 = dtb.NewRow();
            row1["primeiro_nome"] = "Selecione";
            row1["id"] = 0;
            dtb.Rows.InsertAt(row1, 0);

            dropFuncRetFinal.DisplayMember = "primeiro_nome";
            dropFuncRetFinal.ValueMember = "id";
            dropFuncRetFinal.DataSource = dtb;
            dropFuncRetFinal.SelectedIndex = 0;

            dropFuncEntFinal.DisplayMember = "primeiro_nome";
        ...
        private void carregaListagemEntrega()
        {
            ...
            tabListEntregas.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;
            tabListEntregas.Columns["id"].HeaderText = "Cod.";
            tabListEntregas.Columns["primeiro_nome_entrega"].HeaderText = "Mot. Entrega";
            tabListEntregas.Columns["primeiro_nome_entrega"].DisplayIndex = 2;
            ...
            tabListEntregas.Columns["func_entrega"].Visible = false;
        ...
        private void carregaListagemRetiradas()
        {
            ...
            tabListRetiradas.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;
            tabListRetiradas.Columns["id"].HeaderText = "Cód.";
            ...
            tabListRetiradas.Columns["primeiro_nome_entrega"].HeaderText = "Mot. Entrega";
            tabListRetiradas.Columns["primeiro_nome_entrega"].DisplayIndex = 3;
            tabListRetiradas.Columns["veic_entrega"].HeaderText = "Veículo Entrega";
            tabListRetiradas.Columns["primeiro_nome_retirada"].HeaderText = "Mot. Retirada";
            tabListRetiradas.Columns["primeiro_nome_retirada"].DisplayIndex = 10;
            ...
            tabListRetiradas.Columns["mapa"].Visible = false;
            tabListRetiradas.Columns["func_entrega"].Visible = false;
            tabListRetiradas.Columns["id_func_retirada"].Visible = false;
            tabListRetiradas.Columns["func_retirada"].Visible = false;
        ...
        private void carregaFuncListagem()
        {
            ...
            tabFuncListagem.Columns["nome"].Visible = false;
                    ...
                    if (sys_FNCBLL.jaExisteNoBancoBLL("sys_clientes", "registro", txtRegistro.Text))
                    {
                        ...
                        if (sys_FNCBLL.jaExisteNoBancoBLL("sys_enderecos,", "endereco", txtEndereco.Text))
                        {
                            if (sys_FNCBLL.jaExisteNoBancoBLL("sys_locacoes", "sys_endereco_id", mdlLocacao.SYS_ENDERECO_ID.ToString()) == true &&
                                sys_FNCBLL.jaExisteNoBancoBLL("sys_locacoes", "previsao_entrega", mdlLocacao.PREVISAO_ENTREGA.ToString("yyyy-MM-dd HH:mm:ss")) == true &&
                                sys_FNCBLL.jaExisteNoBancoBLL("sys_locacoes", "tipo", mdlLocacao.TIPO) == true)
                            {
        ...
        private void btnLocalizarCliNome_Click(object sender, EventArgs e)
        {
            ...
            {
                tabClientes.DataSource = dtbClientes;
                txtCliente.BackColor = Color.LightCoral;
                timer1.Start();
                MessageBox.Show("Digite um Nome de Cliente para a busca");
            }
            else
            {
        ...
        private void btnLocalizarCliRegistro_Click(object sender, EventArgs e)
        {
            ...
            {
                tabClientes.DataSource = dtbClientes;
                txtRegistro.BackColor = Color.LightCoral;
                timer1.Start();
                MessageBox.Show("Digite um CPF/CNPJ válido");
            }
            else
            {
                dtvClientes.RowFilter = string.Format(@"registro LIKE '{0}'", txtRegistro.Text);
                tabClientes.DataSource = dtvClientes;
            }
        }
        private void txtRegistro_Leave(object sender, EventArgs e)
        {
            if (txtRegistro.Text != "   .   .   -" || txtRegistro.Text != "  .   .   /    -" || txtRegistro.Text != "")
            {
                txtRegistro.BackColor = SystemColors.Window;
            }
        }
        #endregion
        #region LOCALIZA FONES
        private void btnLocalizarCliFone_Click(object sender, EventArgs e)
        {
            ...
            {
                tabClientes.DataSource = dtbClientes;
                txtFone1.BackColor = txtFone2.BackColor = Color.LightCoral;
                timer1.Start();
        ...
        private void txtFone2_Leave(object sender, EventArgs e)
        {
            ...
            {
                txtFone1.BackColor = txtFone2.BackColor = SystemColors.Window;
            }
        }
        ...
        private void dropVisualPorStatus_SelectedIndexChanged_1(object sender, EventArgs e)
        {
        ...
        private void txtMovVisDe_ValueChanged_1(object sender, EventArgs e)
        {
        ...
        private void txtMovVisAte_ValueChanged_1(object sender, EventArgs e)
        {
            dtbLocacoes = sys_locacoesBLL.ListarTudoBLL(txtMovVisDe.Value, txtMovVisAte.Value, queryStatusLocacao);
            tabMov.DataSource = null;
            carregaMovimento(dtbLocacoes);
        }
        private void btn_buscaMov_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                    ...
                    tabMov.CurrentRow.Cells["data_retirada"].Value.ToString() != "")
                {
                        ...
                        tabMov.CurrentRow.Cells["situacao"].Value.ToString() == "Ag.Retirada")
                    {
                        ...
                        int idCont = sys_FNCBLL.MostrarNroConteinerBLL(int.Parse(tabMov.CurrentRow.Cells["numero_conteiner"].Value.ToString()), "ENTULHO").ID;
                ...
                try
                {
                        ...
                        tabMov.CurrentRow.Cells["data_retirada"].Value.ToString() != "")
                    {
                        if (tabMov.CurrentRow.Cells["situacao"].Value.ToString() == "Entregue" || tabMov.CurrentRow.Cells["situacao"].Value.ToString() == "Ag.Retirada")
                        {
                            ...
                            sys_FNCBLL.atualizaStatusConteinerBLL(sys_FNCBLL.MostrarNroConteinerBLL(int.Parse(tabMov.CurrentRow.Cells["numero_conteiner"].Value.ToString()), "ENTULHO").ID, "DISPONÍVEL");
                            tabMov.CurrentRow.Cells["situacao"].Value = "Finalizada";
                        }
                        else
                        {
        ...
        private void tabMov_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == tabMov.Columns["numero_conteiner"].Index)
            {
                ...
                {
                    _nCont = sys_FNCBLL.MostrarNroConteinerBLL(int.Parse(tabMov.Rows[e.RowIndex].Cells["numero_conteiner"].Value.ToString()), "ENTULHO").ID;
                }
                else
                {
                    _nCont = 0;
        ...
        private void tabMov_CellValidated(object sender, DataGridViewCellEventArgs e)
        {
                ...
                int.Parse(tabMov.Rows[e.RowIndex].Cells["numero_conteiner"].Value.ToString()) != _nCont)
            {
                ...
                if (idCont != 0)
                {
                    if (sys_FNCBLL.MostrarNroConteinerBLL(int.Parse(tabMov.CurrentRow.Cells["numero_conteiner"].Value.ToString()), "ENTULHO").SITUACAO == "LOCADO")
                    {
        ...
        private void imprime_pdf()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < motIdPrinc.Count; i++) //numero de páginas corresponde ao número de motoristas selecionados
                {
                    ...
                    double idWidhtRet = 20;
                    double dataEntWidthRet = 50;
                    double prevRetWidthRet = 75;
                    double osWidhtRet = 30;
                    double contWidhtRet = 20;
                    double cobrancaRet = 35;
                    double pagowidhtRet = 20;
                    double valorRet = 30;
                    double endRet = 170;
                    double observacaoRetWidht = pageWidth - (margens + idWidhtRet + dataEntWidthRet + prevRetWidthRet + osWidhtRet + contWidhtRet + cobrancaRet + pagowidhtRet + valorRet + endRet + margens);
                    ...
                    posXRet = new double[] {margens,
                                            margens+idWidth,
                                            margens+idWidth+dataEntWidthRet,
                                            margens+idWidth+dataEntWidthRet+prevRetWidthRet,
                                            margens+idWidth+dataEntWidthRet+prevRetWidthRet+osWidhtRet,
                                            margens+idWidth+dataEntWidthRet+prevRetWidthRet+osWidhtRet+contWidhtRet,
                                            margens+idWidth+dataEntWidthRet+prevRetWidthRet+osWidhtRet+contWidhtRet+cobrancaRet,
                                            margens+idWidth+dataEntWidthRet+prevRetWidthRet+osWidhtRet+contWidhtRet+cobrancaRet+pagowidhtRet,
                                            margens+idWidth+dataEntWidthRet+prevRetWidthRet+osWidhtRet+contWidhtRet+cobrancaRet+pagowidhtRet+valorWidh,
                                            margens+idWidth+dataEntWidthRet+prevRetWidthRet+osWidhtRet+contWidhtRet+cobrancaRet+pagowidhtRet+valorWidh+enderecoWidht};
                    #endregion
                    novalinhaPdf(linha, pageHeight);
                    ...
                    for (int j = 0; j < motIdSecun.Count - 1; j++) //2º for - número de tabelas secindárias dentro da página
                    {
                        if (motIdSecun[j] != motIdPrinc[0])
                        {
                            ...
                            double idWidthRetSec = 20;
                            double dataEntRetSecWidh = 40;
                            double prevRetRetSecWidh = 55;
                            double osRetSecWidht = 25;
                            double contRetSecWidht = 20;
                            double cobrancaRetSecWidth = 35;
                            double pagoRetSecWidht = 20;
                            double valorRetSecWidth = 30;
                            double enderecoRetSecWidth = 170;
                            double observacaoRetSecWidht = pageWidth - (margens + idWidthRetSec + dataEntRetSecWidh + prevRetRetSecWidh + osRetSecWidht + contRetSecWidht + cobrancaRetSecWidth + pagoRetSecWidht + valorRetSecWidth + enderecoRetSecWidth + margens);

                            //"Cod","Data Ent.", "Prev. Ret.", "O.S.", "Cont.", "Cobrança", "Pago", "Valor", "Endereço","Observação"
                            //posXRet = new double[] { 10, 65, 150, 180, 203, 243, 265, 300, 433, 715, 740 };
                            posXRet = new double[] {margens,
                                                margens+idWidthRetSec,
                                                margens+idWidthRetSec+dataEntRetSecWidh,
                                                margens+idWidthRetSec+dataEntRetSecWidh+prevRetRetSecWidh,
                                                margens+idWidthRetSec+dataEntRetSecWidh+prevRetRetSecWidh+osRetSecWidht,
                                                margens+idWidthRetSec+dataEntRetSecWidh+prevRetRetSecWidh+osRetSecWidht+contRetSecWidht,
                                                margens+idWidthRetSec+dataEntRetSecWidh+prevRetRetSecWidh+osRetSecWidht+contRetSecWidht+cobrancaRetSecWidth,
                                                margens+idWidthRetSec+dataEntRetSecWidh+prevRetRetSecWidh+osRetSecWidht+contRetSecWidht+cobrancaRetSecWidth+pagoRetSecWidht,
                                                margens+idWidthRetSec+dataEntRetSecWidh+prevRetRetSecWidh+osRetSecWidht+contRetSecWidht+cobrancaRetSecWidth+pagoRetSecWidht+valorRetSecWidth,
                                                margens+idWidthRetSec+dataEntRetSecWidh+prevRetRetSecWidh+osRetSecWidht+contRetSecWidht+cobrancaRetSecWidth+pagoRetSecWidht+valorRetSecWidth+enderecoRetSecWidth};
                            #endregion
        ...
        {
            txtCliente.BackColor = txtRegistro.BackColor = txtFone1.BackColor = txtFone2.BackColor = SystemColors.Window;
            timer1.Stop();
        }
