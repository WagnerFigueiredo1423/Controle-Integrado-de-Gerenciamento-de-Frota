...
namespace app
{
    public partial class formConteiner : Form
    {
        ...
        private void pagamentoFuncionáriosToolStripMenuItem_Click(object sender, EventArgs e)
        {

        }

        private void valoresDeVTEVRToolStripMenuItem_Click(object sender, EventArgs e)
        {
            formValorVtVr formValorVtVr = new formValorVtVr();
            formValorVtVr.MdiParent = this;
            formValorVtVr.Dock = DockStyle.None;
            formValorVtVr.Show();
        }
    }
}
